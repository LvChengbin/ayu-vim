...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#FAFAFA",  'mirage': "#FFEE99"}

let s:palette.comment   = {'dark': "#999999",  'light': "#ABB0B6",  'mirage': "#999999"}
let s:palette.markup    = {'dark': "#F07178",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#FFEE99",  'light': "#A37ACC",  'mirage': "#A37ACC"}
...
let s:palette.error     = {'dark': "#FF7777",  'light': "#FF7777",  'mirage': "#FF7777"}
let s:palette.accent    = {'dark': "#F29718",  'light': "#FF6A00",  'mirage': "#FFCC66"}
let s:palette.panel     = {'dark': "#14191F",  'light': "#FFFFFF",  'mirage': "#272D38"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#888888"}
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#242B38"}
let s:palette.selection = {'dark': "#253340",  'light': "#F0EEE4",  'mirage': "#888888"}
